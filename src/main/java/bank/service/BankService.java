...
public class BankService {
	...
	public void createCustomerAndAccount(int customerId, String customerName, String emailAddress, String AccountNumber){
		try {
			...
			emailSender.sendEmail(emailAddress, "Accoun not created " + AccountNumber);
			TraceRecord traceRecord = new TraceRecord(new Date(), "Error "+customerName+" with account "+AccountNumber);
			traceRecordRepository.storeTraceRecord(traceRecord);
			throw e;
		}
	}
